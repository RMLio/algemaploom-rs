...
use crate::rml_model::v2::core::expression_map::term_map::SubjectMap;
...
use crate::rml_model::v2::io::source::{LogicalSource, Source};
...
fn stringify_rcterm<T: sophia_api::prelude::Term + Clone>(
    ...
    crate::extractors::stringify_term(term.clone())
...
pub fn extract_logical_source_reference_formulation(
    ...
    ls.iterable
        ...
        .as_ref()
        .and_then(|rf| crate::extractors::stringify_term(&rf.iri))
...
pub fn extract_source_path(triplesmap: &TriplesMap) -> Result<String, String> {
    ...
    match get_object(
        ...
        Ok(path_term) => {
            crate::extractors::stringify_term(path_term)
...
pub fn extract_source_root(triplesmap: &TriplesMap) -> Result<String, String> {
    ...
    match get_object(
        ...
        Ok(root_term) => {
            crate::extractors::stringify_term(root_term)
