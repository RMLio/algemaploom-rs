...
use crate::parser::rml_model::source_target::{LogicalTarget, LdesInformation};
...
mod tests {
    ...
    use crate::parser::extractors::io::load_graph_bread;
    ...
    fn extract_logical_target_ldes() -> ExtractorResult<()> {
        use crate::parser::rml_model::source_target::LogicalTarget;
        use super::Extractor;
