...
use crate::parser::extractors::error::ParseError;
use crate::parser::extractors::Extractor;
use crate::parser::rml_model::term_map::{GraphMap, PredicateMap, TermMapInfo};
...
mod tests {
    ...
    use crate::parser::rml_model::term_map::TermMapType;

    import_test_mods!(parser);
