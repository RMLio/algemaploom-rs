use crate::parser::rml_model::{
    PredicateObjectMap, TriplesMap
};
use crate::parser::rml_model::term_map::{SubjectMap, TermMapType};
...
fn get_template_from_term_map_info(tm_info: &crate::parser::rml_model::term_map::TermMapInfo) -> Result<String, String> {
...
fn get_reference_from_term_map_info(tm_info: &crate::parser::rml_model::term_map::TermMapInfo) -> Result<String, String> {
    match &tm_info.term_map_type {
...
fn get_constant_from_term_map_info(tm_info: &crate::parser::rml_model::term_map::TermMapInfo) -> Result<String, String> {
    match &tm_info.term_map_type {
...
fn get_term_type_from_term_map_info(tm_info: &crate::parser::rml_model::term_map::TermMapInfo) -> Result<String, String> {
...
fn get_value_from_term_map_info(tm_info: &crate::parser::rml_model::term_map::TermMapInfo) -> Result<String, String> {
    match &tm_info.term_map_type {
