...
use super::test_core::{Expectation, Expect};
...
pub fn expect_triples_map_identifier(expected: &str) -> Box<dyn Expectation> {
    expect!(extract_triples_map_identifier, expected.to_string(), "TriplesMap Identifier")
}

pub fn expect_predicate_object_maps_count(expected: usize) -> Box<dyn Expectation> {
    expect!(extract_predicate_object_maps_count, expected, "Predicate-Object Maps Count")
}

pub fn expect_logical_source_iterator(expected: &str) -> Box<dyn Expectation> {
    expect!(extract_logical_source_iterator, expected.to_string(), "Logical Source Iterator")
}

pub fn expect_logical_source_reference_formulation(expected: &str) -> Box<dyn Expectation> {
    expect!(extract_logical_source_reference_formulation, expected.to_string(), "Logical Source Reference Formulation")
}

pub fn expect_subject_map_template(expected: &str) -> Box<dyn Expectation> {
    expect!(extract_subject_map_template, expected.to_string(), "Subject Map Template")
}

pub fn expect_subject_map_has_classes(expected: bool) -> Box<dyn Expectation> {
    expect!(extract_subject_map_has_classes, expected, "Subject Map Has Classes")
}

pub fn expect_subject_map_term_type(expected: &str) -> Box<dyn Expectation> {
    expect!(extract_subject_map_term_type, expected.to_string(), "Subject Map Term Type")
}

pub fn expect_subject_map_first_class(expected: &str) -> Box<dyn Expectation> {
    expect!(extract_subject_map_first_class, expected.to_string(), "Subject Map First Class")
}
...
pub fn expect_predicate_from_pom(index: usize, expected: &str) -> Box<dyn Expectation> {
...
pub fn expect_object_reference_from_pom(index: usize, expected: &str) -> Box<dyn Expectation> {
    let expected_str = expected.to_string();
...
pub fn expect_object_template_from_pom(index: usize, expected: &str) -> Box<dyn Expectation> {
    let expected_str = expected.to_string();
...
pub fn expect_object_term_type_from_pom(index: usize, expected: &str) -> Box<dyn Expectation> {
    let expected_str = expected.to_string();
...
pub fn expect_has_ref_object_map_in_pom(index: usize, expected: bool) -> Box<dyn Expectation> {
...
pub fn expect_ref_object_map_parent_triples_map_from_pom(index: usize, expected: &str) -> Box<dyn Expectation> {
    let expected_str = expected.to_string();
...
pub fn expect_join_condition_child_from_pom(index: usize, expected: &str) -> Box<dyn Expectation> {
    let expected_str = expected.to_string();
...
pub fn expect_join_condition_parent_from_pom(index: usize, expected: &str) -> Box<dyn Expectation> {
    let expected_str = expected.to_string();
...
pub fn expect_subject_map_contains_class(class_uri: &str) -> Box<dyn Expectation> {
